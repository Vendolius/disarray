...
local function v_u_53()
    if v_u_12 and (v_u_12.ui and v_u_12.target) then
        local v27 = v_u_12.ui:FindFirstChild("Icon")
        local v28 = v_u_12.ui:FindFirstChild("Arrow")
        local v29 = v_u_12.ui:FindFirstChild("Attention")
        ...
        if p54:FindFirstChild("Left") and p54:FindFirstChild("Right") then
            ...
            if p55.Type == "Static" then
                ...
                if p55.Type == "Ranged" then
                    ...
                    v_u_13 = v_u_3.RenderStepped:Connect(v_u_53)
                end
                return
            end
        else
