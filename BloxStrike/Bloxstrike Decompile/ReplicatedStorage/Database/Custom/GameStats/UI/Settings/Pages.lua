...
v7["Toggle Inventory Display"] = v31
local v32 = {
    ["Type"] = "Keybind",
    ["Template"] = "KeybindTemplate",
    ["Default"] = {
...
v_u_1.Keybinds = v7
function v_u_1.GetPage(p39)
    return v_u_1[p39]
end
function v_u_1.GetCategory(p40, p41)
    local v42 = v_u_1.GetPage(p40)
    if not v42 then
        return {}
    end
    local v43 = v_u_3()
    ...
    for v45, v46 in pairs(v42) do
        if v46.Category == p41 and (v46.IsEnabled ~= false and (not v46.Platform or table.find(v43, v46.Platform))) then
            v44[v45] = v46
        end
    end
    return v44
end
function v_u_1.GetCategories(p47)
    local v48 = v_u_1.GetPage(p47)
    if not v48 then
        return {}
    end
    local v49 = v_u_3()
    ...
    for _, v52 in pairs(v48) do
        if v52.IsEnabled ~= false and (not v52.Platform or table.find(v49, v52.Platform)) and not v50[v52.Category] then
            local v53 = v52.Category
            table.insert(v51, v53)
            v50[v52.Category] = true
        end
    end
    return v51
end
function v_u_1.GetSetting(p54, p55)
    local v56 = v_u_1.GetPage(p54)
    if v56 then
        return v56[p55]
    else
        return nil
